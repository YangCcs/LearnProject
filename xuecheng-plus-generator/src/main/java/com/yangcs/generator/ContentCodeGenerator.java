...
public class ContentCodeGenerator {
	...
	//数据库密码
	private static final String DATA_SOURCE_PASSWORD  = "200412";
	//生成的表
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/project_" + SERVICE_NAME
